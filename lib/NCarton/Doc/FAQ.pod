...
NCarton::Doc::FAQ - Frequently Asked Questions
...
NCarton allows you to I<lock> these dependencies into a version
...
NCarton provides a way to install specific versions of distributions
from CPAN, or any CPAN-like mirrors (as well as git repositories in
the future version of NCarton).
...
NCarton automatically maintains the L<cpanfile.snapshot> file, which is meant
...
=head2 I already use Pinto to create DarkPAN mirror. Can I use NCarton with this?

Yes, by specifying Pinto mirror as your NCarton mirror, you can take a
...
NCarton, turn off the I<devel> local::lib and create a new one, like
I<myapp>. Install L<NCarton> and all of its dependencies to the
...
=item Re-install NCarton on you perlbrew environment

Run C<< cpanm -f NCarton >>. This will force-install NCarton,
